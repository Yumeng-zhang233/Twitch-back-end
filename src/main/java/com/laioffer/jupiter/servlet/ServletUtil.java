...
public class ServletUtil {
    public static<T> void writeData(HttpServletResponse response,//add static to avoid new initialization,save memory
                                    T itemMap) throws IOException {
    ...
    public static String encryptPassword(String userId, String password) throws IOException {
        return DigestUtils.md5Hex(userId + DigestUtils.md5Hex(password)).toLowerCase();//convert string to md5Hex
    }///////////////////////////////salt(unique id) + password 的md5值
